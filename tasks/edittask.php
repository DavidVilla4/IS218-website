        ...
        <form method="post" action="edittask.php" autocomplete="off">
                ...
                <div class="flex-container-horizontal">
                    ...
                    <div class="flex-item-horizontal-right">
                        <select name="urgency" id="urgency" >
                            ...
                            <option value="med" <?php if ($result["urgency"] == "med") echo "selected"; ?>>Medium</option>
            ...
            <div class="tasks-container">
                <div class="tasks-items" style="justify-content: ">
                    <button type="submit" name="submitedit" value="submitedit" class="new-task-button">Edit Task</button>
                </div>
            </div>
        </form>
    </div>
